...
const defaultProps: Card01Props = {
    ...
    content: {
        text: "Just launched You&I UI! Check out the documentation and let me know what you think 🎨",
        link: {
            title: "You&I UI Documentation",
            description: "A comprehensive guide to You&I UI",
